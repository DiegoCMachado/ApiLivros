examples_patch_livraria_invalid_payload = [
    ("payload_vazio", 400),
    ("None", 400),
    ("null", 400),
    ("hash_vazio", 400),
...
examples_patch_livraria_invalid_values = [
    ("nome", "123", 400),
    ("nome", "123.to_i", 400),
    ("nome", "123.to_f", 400),
    ("nome", "None", 400),
    ...
    ("dataPublicacao", "12-11-2045", 400),
    ("dataPublicacao", "12/11/2045", 400),
    ("dataPublicacao", "2024/11/11", 400),
    ("qtdePaginas", "123", 400),
...
examples_patch_livraria_no_fields = [
    ("nome", 200),
    ("autor", 200),
    ("dataPublicacao", 200),
    ("qtdePaginas", 200)
...
examples_patch_id_livraria_invalid_values = [
    ("123", 400),
    ("123.to_i", 400),
    ("123.to_f", 400),
    ("None", 400),
